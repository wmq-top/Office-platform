<template>
  <div id="scrollCard">
    <div class="scrollCard" @mouseenter="showBtn(true)" @mouseleave="showBtn(false)" :class="skinMode">
      ...
      <div class="scrollContent">
        <div class="scrollList" :style="`width:${Listdata.length * 180}px`">
          <div class="scrollListItem" v-for="(item, index) in Listdata">
            {{ item.tip }}
            <div class="iconList">
...
export default {
  ...
  computed: {
    ...
    Listdata() {
      return [
        { name: "已解决", tip: this.$t("wds.Resolved", this.Language) },
        { name: "未解决", tip: this.$t("wds.Unresolved", this.Language) },
        { name: "审核通过", tip: this.$t("wds.UnderReview", this.Language) },
        { name: "审核驳回", tip: this.$t("wds.Reviewed", this.Language) },
        { name: "审核中", tip: this.$t("wds.AuditFailed", this.Language) },
      ];
    },
  },
  methods: {
